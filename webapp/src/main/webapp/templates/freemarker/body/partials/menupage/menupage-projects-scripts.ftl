...
<script type="text/javascript">
    ...
    var i18nStrings = {
        ...
        indNamesStartWithFilter: '${i18n().individuals_names_starting_with_filters?js_string}',
        plsChangeSelection: '${i18n().pls_change_your_selection?js_string}',
        withTheseSelectedFilters : '${i18n().with_the_selected_filters?js_string}'
    };
</script>
...
${scripts.add('<script type="text/javascript" src="${urls.base}/js/jquery_plugins/jquery.scrollTo-min.js"></script>',
              '<script type="text/javascript" src="${urls.base}/js/menupage/browseByVClassAndFilter.js"></script>')}
